...
export default function Room({ roomId, playerId, isAdmin, room, onLeave }) {
      ...
      <div className="room-body">
        ...
        <div className="room-main">
          ...
          <div className="story-section">
            ...
            {isAdmin && (
              <form
                className="story-input-row"
                onSubmit={handleSetStory}
                style={{ marginTop: 12 }}
              >
                <input
          ...
          {/* Results */}
          {revealed && (
            <VoteResults players={players} currentStory={currentStory} />
          )}
